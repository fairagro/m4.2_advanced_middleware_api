...
- [ ] 1.1 Record Devinfra `main` commit SHA to use for this adopt (document in
...
- [ ] 1.6 Copy verbatim first-party `.agents/skills/arctrl/` from Devinfra
...
- [ ] 3.1 Rewrite `openspec/principles.md` as P3 product overlay (extends
