...
2. Navigate to the group settings and create a group access token with the following features:

   - scopes: api, write_repository
   - role: owner/maintainer

   Note: if you would like to run the integration tests defined within this repo, you're access token needs to have the
